...
document.addEventListener('keydown', (e) => {
  ...
  switch (key) {
    ...
    default: {
      ...
      if (key.length > 1) return // it allows normal key behavior works fine
...
function onInputChange(input, newValue) {
    ...
    // changing logo based on the first 4 digits in input.
...
// keep focus or cursor on the last data entered place
...
document.addEventListener("paste", e => {
    ...
    e.preventDefault() // preventing standard prevent default happening 
    // our own paste func below
